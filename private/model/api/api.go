...
func (a *API) resetImports() {
	a.imports = map[string]bool{
		"bluet-deps/aws-sdk-go/aws": true,
	}
}
...
func (a *API) APIGoCode() string {
	a.resetImports()
	delete(a.imports, "bluet-deps/aws-sdk-go/aws")
	a.imports["bluet-deps/aws-sdk-go/aws/awsutil"] = true
	a.imports["bluet-deps/aws-sdk-go/aws/request"] = true
...
func (a *API) ServiceGoCode() string {
	a.resetImports()
	a.imports["bluet-deps/aws-sdk-go/aws/client"] = true
	a.imports["bluet-deps/aws-sdk-go/aws/client/metadata"] = true
	a.imports["bluet-deps/aws-sdk-go/aws/request"] = true
	if a.Metadata.SignatureVersion == "v2" {
		a.imports["bluet-deps/aws-sdk-go/private/signer/v2"] = true
		a.imports["bluet-deps/aws-sdk-go/aws/corehandlers"] = true
	} else {
		a.imports["bluet-deps/aws-sdk-go/private/signer/v4"] = true
	}
	a.imports["bluet-deps/aws-sdk-go/private/protocol/"+a.ProtocolPackage()] = true
...
func (a *API) InterfaceGoCode() string {
	a.resetImports()
	a.imports = map[string]bool{
		"bluet-deps/aws-sdk-go/aws/request":           true,
